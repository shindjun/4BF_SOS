...
# 각 구간 ORE → Fe 환산
normal_fe = ore_per_charge * charge_rate * (normal_elapsed / 60) * (tfe_percent / 100)
abnormal_fe = ore_per_charge * charge_rate * (abnormal_elapsed / 60) * (tfe_percent / 100)
reduction_fe = ore_per_charge * charge_rate * (reduction_elapsed / 60) * (tfe_percent / 100)
after_fe = ore_per_charge * charge_rate * (after_elapsed / 60) * (tfe_percent / 100)
